...
let v ?(name="OCurrent") ?authn ?(secure_cookies=false) ?custom_css ~has_role routes =
  ...
  { name; authn; has_role; secure_cookies; session_backend = Sqlite_session.create db; router; nav_links; custom_css }
